      ...
      {products ? (
        products.map((product) => (
          ...
          >
            ...
            <div className="bg-lime-50 flex flex-col justify-between flex-grow p-4">
              <div>
                <h3 className="text-base font-semibold text-brand-charcoal mb-1">
                  {product.title}
                </h3>
                <p className="text-sm text-brand-slate mb-2 capitalize">
                  Category: {product.category}
                </p>
                <p className="text-sm text-brand-slate mb-2 line-clamp-3">
                  {product.description}
                </p>
              ...
              <div className="flex justify-between items-center mt-4">
                ...
                <button
                  ...
                  className="bg-pink-700 hover:bg-brand-orange/90 text-white text-sm px-3 py-1 rounded transition"
                >
        ...
        <p className="col-span-full text-center text-brand-slate animate-pulse">
          Loading...
        </p>
      )}
    </div>
